...
// Sections planned for the Grid Operator, from the marking scheme.
const PLANNED_SECTIONS = [
  { title: 'Battery slot availability', detail: 'Update the slots open at each station.', owner: 'Member B' },
  { title: 'Booking monitor', detail: 'Watch power trading bookings as they come in.', owner: 'Member C' },
